process TRIMMING {
        tag "TRIMM on $name using $task.cpus CPUs and $task.memory memory"
        publishDir "${params.outDirectory}/${sample.run}/trimmed/", mode:'copy'
...
process VARDICT {
        ...
        """
        echo VARDICT $name
        source /home/anna/miniconda3/bin/activate kamilavardict
...
process NORMALIZACE {
        ...
        source /home/anna/miniconda3/bin/activate bcftoolsbgziptabix 
        bgzip $vardict 
        tabix ${name}.vcf.gz
...
process COVERAGE {
        ...
        """
        echo ANOTACE $name
        source /home/anna/miniconda3/bin/activate kamila
